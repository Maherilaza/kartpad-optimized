...
| --- | --- | --- |
| Android ARM64 | [0.4.23 Android 1 · code 104](https://github.com/chrissotraidis/kartpad/releases/tag/v0.4.23-android.1) | [Android 9+ with Vulkan](docs/INSTALL_ANDROID.md) |
| iPhone / iPad | [0.4.23 · build 46](https://github.com/chrissotraidis/kartpad/releases/tag/v0.4.23-ios.1) | [iOS/iPadOS 16+; re-sign the IPA](docs/INSTALL_IPA.md) |
...
**0.4.23 brings a new racing launcher**, a shared HD icon, dark/light mode, a preferred-game selector, and a repair for licenses whose Mii is missing. Android performance remains an active area of work.
...
Yes—use the [platform downloads above](#downloads). The current public iPhone/iPad build is **0.4.23 build 46**; Mac and Apple TV have separate packages. Apple IPAs need re-signing. Every package requires your own supported game data. A [Personal IPA Builder](docs/BUILDER.md) is also available.
