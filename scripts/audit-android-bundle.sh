...
[[ "$manifest" == *"<uses-sdk android:minSdkVersion=\"$expected_min_sdk\" android:targetSdkVersion=\"36\"/>"* ]] || {
  echo "ERROR: bundle minimum SDK does not match $expected_min_sdk" >&2; exit 1;
}
